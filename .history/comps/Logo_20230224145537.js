...
export default function Logo() {
    ...
    return ( <><div className={styles.logocont}>
        ...
        <BiMenu size={40} onClick={handleClick} />
            ...
            <div style={{display: open ? "flex" : "none", backgroundColor:'white', height:200, width:250,borderRadius:10, color:"#7880B5", padding:20, flexDirection:'column', marginBottom:10 }}>
                <Link href="/">Home</Link>
