...
export default function Channels({channels: initialChannels}) {
    ...
    return (
        <div style={{backgroundColor:"#7880B5", fontFamily:'play, sans-serif'}}>
            ...
            <h1 style={{color:'#BCC4DB', fontFamily:'play, sans-serif', display:'flex', paddingBottom:50, padding:'5%'}}>Choose your channel</h1>
            <div style={{backgroundColor:"#6987C9", textAlign:'left',width:'55%', height:'100%', 
            borderRadius:10, padding:'5%',textDecoration:'underline'}}>
